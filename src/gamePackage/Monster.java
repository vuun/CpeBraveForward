...
public class Monster {
	...
	public Monster(float x, float y, float width, float height, float mass)
	...
	public void dogRun() throws SlickException {
		...
		if (animation == 1) {
			image = new Image("res/Dog2.png");
		}
		if (animation == 2) {
			image = new Image("res/Dog3.png");
		}
		if (animation == 3) {
			image = new Image("res/Dog4.png");
		}
		if (animation == 4) {
			image = new Image("res/Dog5.png");
		}
	}
	...
	void animationTimesControl(MainGame mainGame) {
		animationTimes += 0.01 * mainGame.deltax / 1.5;
		if (animationTimes >= 1) {
			animationTimes = 0;
			animation += 1;
			if (animation >= 5) {
